...
@Component( {
    selector: 'app-workflow-starships',
    templateUrl: './workflow-starships.component.html',
    styleUrls: ['./workflow-starships.component.css']
} )
export class WorkflowStarshipsComponent implements OnInit {
